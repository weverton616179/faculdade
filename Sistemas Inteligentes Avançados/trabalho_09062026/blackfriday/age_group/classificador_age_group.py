...
MODEL_DIR = Path(__file__).resolve().parent        # blackfriday/age_group/
...
X_train_processed = pd.concat([X_train_num_scaled, X_train_nom_enc], axis=1)
X_test_processed  = pd.concat([X_test_num_scaled,  X_test_nom_enc], axis=1)
